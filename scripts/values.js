...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function createItemCard(item) {
    ...
    const image_url = `https://jailbreakchangelogs.xyz/assets/items/${image_type}s/${item.name}`;
    ...
    if (item.type === "Drift") {
      ...
      <div class="media-container">
        ...
        <img 
          src="https://jailbreakchangelogs.xyz/assets/items/drifts/thumbnails/${item.name}.webp"
        ...
        >
        <video 
          src="https://jailbreakchangelogs.xyz/assets/items/items/drifts/${item.name}.webm"
  ...
  function preloadItemImages() {
    ...
    for (const item of allItems) {
      ...
      const image_type = item.type.toLowerCase();
      const image_url = `https://jailbreakchangelogs.xyz/assets/items/${image_type}s/${item.name}.webp`;
...
function preloadDriftThumbnails(driftItems) {
  ...
  driftItems.forEach((item) => {
    const img = new Image();
    img.src = `https://jailbreakchangelogs.xyz/assets/items/drifts/thumbnails/${item.name}.webp`;
  });
}
